...
const SHELL_CACHE = `${CACHE_PREFIX}release23-1-1-license-shell-v2`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release23-1-1-license-runtime-v2`;
...
self.addEventListener("fetch", event => {
    ...
    if(url.origin===self.location.origin && /\/js\/(license-config|license-client|security-hardening)\.js$/i.test(url.pathname)){
