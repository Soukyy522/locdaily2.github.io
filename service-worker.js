...
const SHELL_CACHE = `${CACHE_PREFIX}release22-2-linked-system-theme-shell-v1`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release22-2-linked-system-theme-runtime-v1`;
...
const APP_SHELL = [
    ...
    "./assets/icons/maskable-512.png", "./style.css", "./css/global-responsive-navigation.css", "./css/multi-store-dashboard-theme.css", "./css/system-pages-shared-theme.css", "./setting.js", "./employee-id.js",
    "./js/pwa-manager.js", "./js/security-hardening.js", "./js/qa-runtime.js", "./js/recovery-service.js", "./js/global-system-navigation.js", "./js/shared-system-theme.js",
