...
const SHELL_CACHE = `${CACHE_PREFIX}release23-1-license-shell-v1`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release23-1-license-runtime-v1`;
...
self.addEventListener("fetch", event => {
    ...
    if(url.origin===self.location.origin && /\/js\/license-config\.js$/i.test(url.pathname)){
