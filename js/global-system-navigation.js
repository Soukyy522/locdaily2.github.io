(function(){
     ...
     */
    const ROUTES=[
        {page:"dashboard.html",icon:"📊",label:"Dashboard",group:"Utama",roles:["owner","admin","kasir"],quick:true,feature:"dashboard"},
        {page:"absensi.html",icon:"📝",label:"Absensi",group:"Utama",roles:["owner","admin","kasir"],feature:"attendance"},
        {page:"kasir.html",icon:"💵",label:"Kasir",group:"Utama",roles:["owner","admin","kasir"],quick:true,feature:"pos"},
        {page:"barang.html",icon:"📦",label:"Barang",group:"Inventori",roles:["owner","admin"],badge:"navBadge",feature:"inventory"},
        ...
        {page:"multi-store.html",icon:"⇄",label:"Multi-Toko & Transfer",group:"Inventori",roles:["owner","admin"],quick:true,feature:"multi_store"},
        {page:"supplier.html",icon:"🏢",label:"Supplier",group:"Supplier & Pembelian",roles:["owner","admin"],feature:"suppliers"},
        {page:"Purchase-Order.html",icon:"🛒",label:"Purchase Order",group:"Supplier & Pembelian",roles:["owner","admin"],badge:"pendingPOBadge",feature:"purchase_order"},
        {page:"goods.receipt.html",icon:"📥",label:"Goods Receipt",group:"Supplier & Pembelian",roles:["owner","admin"],badge:"pendingGRBadge",feature:"goods_receipt"},
        {page:"retur.html",icon:"↩️",label:"Retur",group:"Keuangan & Laporan",roles:["owner","admin","kasir"],feature:"returns"},
        {page:"laporan.html",icon:"📑",label:"Laporan",group:"Keuangan & Laporan",roles:["owner","admin","kasir"],quick:true,feature:"reports"},
        ...
        {page:"eod.html",icon:"🌙",label:"End of Day",group:"Closing & Data",roles:["owner","admin"],requiresEodReady:true,feature:"eod"},
    ...
    function routeAllowed(route,role,eodReady){
        ...
        if(route.feature && window.LDMLicense && !window.LDMLicense.hasFeature(route.feature))return false;
        return true;
    }
    ...
    function render(){
        ...
        if(desktopReady&&mobileReady){
            if(window.LDMLicense)window.LDMLicense.applyFeatureVisibility(document);
    ...
    window.addEventListener("ldm-license-ready",()=>render());
